export default function CategoryProductsFilterButtonSection() {
  return (
    <div className="flex items-center space-x-4">
      <button
        ...
        type="button"
        className="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium sm:w-auto"
      >
        <svg
